      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 grid md:grid-cols-12 gap-8 items-stretch">
        ...
        <div className="md:col-span-5">
          <div className="hero-image-wrapper w-full bg-[var(--near-black)] overflow-hidden relative min-w-0">
            <img src={heroImage} alt="Portrait of Mateus Monteiro" className="hero-image absolute inset-0 transform transition-all duration-500 ease-[cubic-bezier(0.16,1,0.3,1)] hover:filter-none filter grayscale-20 contrast-90" />
